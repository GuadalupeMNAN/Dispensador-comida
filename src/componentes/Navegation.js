...
// desativado por el navegacion2
function MyStack() {
    return (
        <Stack.Navigator>
            <Stack.Screen
                name="Usuarios" component={ScreenUser} />

            <Stack.Screen
                name="Detalles" component={UserDetalles} />

            <Stack.Screen
                name="nuevouser" component={Nuevouser} />

            <Stack.Screen
                name="EditarUser" component={Editaruser} />
        </Stack.Navigator>
    )
}
...
function Mytabs() {
    return (
        <Tab.Navigator initialRouteName="menu" screenOptions={{ tabBarActiveTintColor: 'blue' }}>
            ...
            <Tab.Screen options={{
                tabBarBadge: '2', tabBarIcon: ({ color, size }) =>
